...
const Two = () => {
    return (
        <div className={styles.containerTwo}>
            ...
            <p>
              The power of a ‘commonplace book’ is to act on the knowledge you gain from books and other sources and to reflect on it. You can open your commonplace collection after reading a book and see which quotes, diagrams or facts have stuck out for you.
              <br />
              <br />
